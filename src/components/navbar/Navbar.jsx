  ...
  return (
    <nav className='w-full bg-white shadow'>
      ...
      <div>
        ...
        >
          <ul
            className={`navbar ${navbar ? null : 'mx-[100px]'}`}
          >
            <li className='nav-hov text-white hover:scale-120 bree-font'>Inicio</li>
            <li className='nav-hov text-white hover:scale-120 bree-font'>Historia</li>
            <li className='nav-hov text-white hover:scale-120 bree-font'>Contacto</li>
            {/*
